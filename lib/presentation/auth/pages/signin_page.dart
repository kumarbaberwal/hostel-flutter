...
class _SigninPageState extends State<SigninPage> {
  ...
  Widget loginButton(UserSigninRequest userSigninRequest) {
    return Builder(builder: (context) {
      return BasicAppButton(
          onPressed: () {
            if (_formKey.currentState!.validate()) {
              userSigninRequest.emailAddress = _emailController.text.trim();
              userSigninRequest.password = _passwordController.text.trim();
              context.read<ButtonBloc>().add(
                  ButtonPressedEvent(usecase: SigninUseCase(), params: userSigninRequest));
            }
          },
          title: 'Login');
    });
